...
## 🏥 Profissão Atual
Atualmente estou trabalhando no <b>Hospital Universitário Pedro Ernesto (HUPE)</b> como <b>Técnico em Informática.</b> Realizo funções como:
- Suporte técnico, manutenção de infraestrutura e auxílio na resolução de problemas sistêmicos da unidade hospitalar
...
## Speed-Veiculos
Desenvolvi e aperfeiçoei este projeto durante os meus estudos sobre banco de dados relacional SQL e realizei uma apresentação sobre ele no meu trabalho de conclusão de curso.<br/><br/>
